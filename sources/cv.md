...
Seeking a challenging position in software engineering, ideally in a
cross-functional agile environment, where I can effectively contribute my skills
and knowledge as a software engineer in an innovative organisation that values
my passion for creativity. I like to work in an environment that offers
opportunities to learn and apply skills to build something with a sense of
ownership.
...
Joined Valtech as a Senior Java/Scala consultant.
...
- In-house BigData Analytics product, which produces reports from the
    ad delivery/engagement logs generated by the ad server.
